...
public class ObjectCopy1 {
	...
	public static void main(String[] args) {
		...
		//실제 데이터를 저장하는 힙영역에 기억장소는 생성이 안되어있다.
		Book[] bookArray1 = new Book[3]; //원본 배열
		Book[] bookArray2 = new Book[3]; //사본 배열
		
		//실제 데이터를 저장하는 힙영역에 기억장소가 생성된 것을 의미한다.
		bookArray1[0] = new Book("태백산맥", "조정래");
		bookArray1[1] = new Book("데미안", "헤르만 헤세");
		bookArray1[2] = new Book("어떻게 살 것인가", "유서민");
		...
		//bookArray2 배열의 복사된 데이터를 출력 확인
		System.out.println("bookArray2 배열 데이터 출력");
